  ...
  return (
    ...
    >
      ...
      >
        <circle
          ...
          strokeDasharray={`${indeterminate
            ...
            : arcPriority === 'default'
              ...
              : (circumference * (100 - 2 * gapPercent[size])) / 100 / 2} ${circumference}`}
        />
        {(value > 0 || arcPriority === 'equal') && !indeterminate && (
          <circle
            ...
            stroke={primary}
            strokeDasharray={`${arcPriority === 'default'
      ...
      {showValue && size !== 'tiny' && !indeterminate && (
        <div aria-hidden="true" className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform">
          <p
